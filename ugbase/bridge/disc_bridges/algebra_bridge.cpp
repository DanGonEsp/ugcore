...
//	NewtonSolver
	{
		...
		reg.add_class_<T, TBase, TBase2>(name, grp)
			...
			.add_method("set_reassemble_J_freq", &T::set_reassemble_J_freq, "reassemble freq. for Jacobian")
            ...
            .add_method("total_average_non_linear_rates", &T::total_average_non_linear_rates, "total average conv rate of newton solver", "")
